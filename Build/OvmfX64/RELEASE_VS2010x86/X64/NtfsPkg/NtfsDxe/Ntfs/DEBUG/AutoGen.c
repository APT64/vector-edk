...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf50248a9, 0x2f4d, 0x4de9, {0x86, 0xae, 0xbd, 0xa8, 0x4d, 0x07, 0xa4, 0x1c}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Ntfs";
...
{
  return NtfsEntryPoint (ImageHandle, SystemTable);
}
