...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFEDE0A1B, 0xBCA2, 0x4A9F, {0xBB, 0x2B, 0xD9, 0xFD, 0x7D, 0xEC, 0x2E, 0x9F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "StatusCodeRuntimeDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdStatusCodeUseOEM = _PCD_VALUE_PcdStatusCodeUseOEM;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdStatusCodeUseDataHub = _PCD_VALUE_PcdStatusCodeUseDataHub;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdAcpiPmBaseAddress = _PCD_VALUE_PcdAcpiPmBaseAddress;
...
#define _PCD_TOKEN_PcdReportStatusCodePropertyMask  41U
...
#define _PCD_TOKEN_PcdSpinLockTimeout  72U
...
{
  return StatusCodeRuntimeDxeEntry (ImageHandle, SystemTable);
}
