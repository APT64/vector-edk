...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1EC0F53A, 0xFDE0, 0x4576, {0x8F, 0x25, 0x7A, 0x1A, 0x41, 0x0F, 0x58, 0xEB}};
...
{
  return PeiStatusCodeDriverEntry (FileHandle, PeiServices);
}
