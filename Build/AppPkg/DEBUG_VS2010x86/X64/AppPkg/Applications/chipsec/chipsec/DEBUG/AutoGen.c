...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC2AA29A2, 0x065C, 0x4FC5, {0xBE, 0x01, 0x7F, 0xAA, 0x76, 0x1E, 0xAA, 0x7E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "chipsec";
...
#define _PCD_TOKEN_PcdMaximumLinkedListLength  1U
...
#define _PCD_TOKEN_PcdMaximumDevicePathNodeCount  5U
...
#define _PCD_TOKEN_PcdUgaConsumeSupport  10U
